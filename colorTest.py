...
image2 = colour.color_box((200,100), triadic[1])
image3 = colour.color_box((200,100), triadic[2])

image1 = colour.add_text(image1, triadic[0], font, 'white', 'black', 3)
image2 = colour.add_text(image2, triadic[1], font, 'white', 'black', 3)
image3 = colour.add_text(image3, triadic[2], font, 'white', 'black', 3)
